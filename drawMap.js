...
function createMap(nepal) {
    ...
    legend.append("rect")
        .attr("x", 0)
        .attr("y", function (d, i) {
            return 0.80 * height - (i * legendHeight) - 2 * legendHeight;
        })
    ...
    legend.append("text")
        ...
        .attr("x", 25)
        .attr("y", function (d, i) {
            return 0.80 * height - (i * legendHeight) - legendHeight - 4;
        })
        .text(function (d, i) {
    ...
    function mouseclick(nepal) {
        ...
        if(document.getElementById("langT").getAttribute("current")==="Nepali") {
            ...
            districtName= nepal.properties.DISTRICT.charAt(0).toUpperCase()
        ...
        titleElement.appendChild(titleElement.ownerDocument.createTextNode(districtName));
        ...
        function updateBar(data) {
            ...
            function aggregateValues(subDivision) {
                var result = data.filter(function (data) {
                    return data.Subdivision == subDivision &&
                        data.District.toLowerCase() == nepal.properties.DISTRICT.toLowerCase();
                }).map(function (data) {
                    return data.no;
                }).reduce(function (a, b) {
            ...
            function updateBarChart(divId, barChartId, colorBar) {
                ...
                var yLabel= plot.selectAll("text.yAxis")
                    .data(sum)
                    .transition()
                    .duration(750)
                    ...
                    .attr("x", function (d, i) {
                        return (i * (width / sum.length)) + ((width / (sum.length + 4) - barPadding) / 2);
                    })
                    .attr("y", function (d) {
    ...
    function mouseover(nepal) {
       ...
       var absoluteMousePos = d3.mouse(bodyNode);
        ...
        if(selectedTab.getAttribute("thisValue")=="noOfHit") {
            ...
            if(document.getElementById("langT")
                    .innerHTML==="English") {

                toolTipDiv
                    .html("<span class='tooltipTitle'>"
                    + districtName + "</span>"
                    + "<span class='tooltipValue'>"+
                    " कुल भुइचालोको शांख्य: "+ nepal.no.toLocaleString('ne-NP') + "</span>" )
                ;
            ...
            toolTipDiv
                ...
                + districtName + "</span>"
                + "<span class='tooltipValue'>"+
                " No of Earthquakes: " + nepal.no + "</span>" )
            ;
            }
        }
        ...
        if(selectedTab.getAttribute("thisValue")=="maxMagnitude") {
            ...
            if(document.getElementById("langT")
                ...
                toolTipDiv
                   .html("<span class='tooltipTitle'>" +
                    districtName + "</span>" +
                    "<span class='tooltipValue'>"+
                    " अधिकतम्  भुइचालो : " +nepal.maxHit.toLocaleString('ne-NP') +
                    "</span>" )
                ;
            }else{
            toolTipDiv
            .html("<span class='tooltipTitle'>" +
                districtName + "</span>" +
                "<span class='tooltipValue'>"+
                " Maximum Magnitude: " + nepal.maxHit +
                "</span>" )
            ;
            }
        }
        ...
        if(selectedTab.getAttribute("thisValue")=="noOfHit") {
            ...
            if(document.getElementById("langT")
                ...
                toolTipDiv
                    ...
                    + districtName + "</span>"
                    + "<span class='tooltipValue'>"+
                    " कुल भुइचालोको शांख्या : " + nepal.no.toLocaleString('ne-NP') + "</span>" )
                ;
            }else{
            toolTipDiv
                .html("<span class='tooltipTitle'>"
...
function createBar(data) {
    ...
    var titleElement = document.getElementById("districtSelected");
    //titleElement.removeChild(titleElement.firstChild);
    titleElement.appendChild(titleElement.ownerDocument.createTextNode("Overall"));
    ...
    function createBarChart(divId, barChartId) {
        ...
        //draw bargraph
        var plotBar = plot.selectAll("rect")
                .data(sum)
                .enter()
                .append("rect")
        ...
        var xLabels = svg.append("g")
                .attr("transform", "translate(" + (margin.left - 18) + "," + (margin.top + height) + ")")
                .style("height", "100%")
                .style("width", "100%")
            ;
        xLabels.selectAll("text.xAxis")
            ...
            .attr("x", function (d, i) {
                return (i * (width / subDivision.length)) + ((width / (subDivision.length + 4) - barPadding) / 2)
            })
            .attr("y", 15)
            .attr("class", "xAxis");

        //add y labels to plot
        var yLabel=plot.selectAll("text")
            .data(sum)
            .enter()
            .append("text")
            .attr("text-anchor", "middle")
...
function updateBarOnSelect() {
    ...
    //var selectedMode=document.getElementById("selectMode");
    var title;
    if (document.getElementById("selectMode").value.localeCompare("Government") == 0) {
...
8
    ...
    //title
    // console.log(districtName);
    svg.selectAll("text.barchartTitle")
        .attr("x", 46)
        .attr("y", 30)
        .transition()
        .duration(750)
...
function resetBarChart() {
    ...
    if(document.getElementById("langT").getAttribute("current")==="English") {
        ...
        titleElement.appendChild(titleElement.ownerDocument.createTextNode("सम्पुर्ण"));
    }
    ...
    var overallValuesHC = document.getElementById("ID").getAttribute("overallValuesHC").split(" ");
    var overallGovtID = document.getElementById("ID").getAttribute("overallGovernmentValuesID").split(" ");
    var overallPrivateID = document.getElementById("ID").getAttribute("overallPrivateValuesID").split(" ");
...
function changeLanguage(){
   ...
   document.getElementById("langT").setAttribute("current","Nepali");
   document.getElementById("about").innerHTML="एस बारेमा";
   document.getElementById("langT").innerHTML="English";

    document.getElementsByClassName("maptitle")[0]
        .innerHTML="नेपालको महाभूकम्प (विसं २०७२ बैसाख १२)";

    document.getElementById("noOfHitTab").innerHTML="कुल भुइचालोको शांख्या (पराकम्पन सहित)";
    document.getElementById("maxMagnitudeTab").innerHTML="अधिकतम्  भुइचालो";
    document.getElementById("alldistrict").value="सम्पुर्ण जिल्लाहरु";
    document.getElementById("districtSelected").innerHTML="सम्पुर्ण";
    document.getElementById("selectMode").options[0]
        .innerHTML="सरकारी";
    document.getElementById("selectMode").options[1]
        .innerHTML="निजी";
    ...
    if (selectedTab.getAttribute("thisValue") === "noOfHit"){
        ...
        document.getElementById("legendText3").innerHTML=
            "१००+";
        document.getElementById("legendText2").innerHTML=
            "५०-१००";
        document.getElementById("legendText1").innerHTML=
            "<५०";
        document.getElementById("legendText0").innerHTML=
            "०";
    ...
    document.getElementsByClassName("barchartTitle")[0]
        .innerHTML="मानविय क्षति";
    document.getElementsByClassName("barchartTitle")[1]
        .innerHTML="पूर्वाधार क्षति";
    document.getElementsByClassName("xAxis")[0]
        .innerHTML="मृत्यु";

    document.getElementsByClassName("xAxis")[1]
        .innerHTML="घाइते";

    document.getElementsByClassName("xAxis")[2]
        .innerHTML="सम्पुर्ण क्षति";

    document.getElementsByClassName("xAxis")[3]
        .innerHTML=" आन्शिक क्षति";

		var death=(document.getElementsByClassName("yAxis")[0]
            .innerHTML).replace(/\,/g,'');
		var injured=(document.getElementsByClassName("yAxis")[1]
            .innerHTML).replace(/\,/g,'');
		var fully=(document.getElementsByClassName("yAxis")[2]
            .innerHTML).replace(/\,/g,'');
		var partial=(document.getElementsByClassName("yAxis")[3]
            .innerHTML).replace(/\,/g,'');
		

        document.getElementsByClassName("yAxis")[0]
            .innerHTML=(parseInt(death)).toLocaleString('ne-NP');

        document.getElementsByClassName("yAxis")[1]
            .innerHTML=(parseInt(injured)).toLocaleString('ne-NP');

        document.getElementsByClassName("yAxis")[2]
            .innerHTML=(parseInt(fully)).toLocaleString('ne-NP');

        document.getElementsByClassName("yAxis")[3]
            .innerHTML=(parseInt(partial)).toLocaleString('ne-NP');
			


        }
    else{
        document.getElementById("langT").setAttribute("current","English");
        document.getElementById("about").innerHTML="About";
        document.getElementById("langT").innerHTML=" नेपाली";

        document.getElementsByClassName("maptitle")[0]
            .innerHTML="Nepal Earthquake 2015";

        document.getElementById("noOfHitTab").innerHTML="NUMBER OF EARTHQUAKES/AFTERSHOCKS";
        document.getElementById("maxMagnitudeTab").innerHTML="MAXIMUM MAGNITUDE OF EARTHQUAKE";
        document.getElementById("alldistrict").value="All districts";
        document.getElementById("districtSelected").innerHTML="Overall";
        document.getElementById("selectMode").options[0]
            .innerHTML="Government";
        document.getElementById("selectMode").options[1]
            .innerHTML="Private";
        ...
        document.getElementsByClassName("barchartTitle")[0]
            .innerHTML="Human Causalities";
        document.getElementsByClassName("barchartTitle")[1]
            .innerHTML="Infrastructure Damage";
        document.getElementsByClassName("xAxis")[0]
            .innerHTML="Death";
        document.getElementsByClassName("xAxis")[1]
            .innerHTML="Injured";
        ...
        document.getElementsByClassName("xAxis")[2]
            .innerHTML="Fully Damaged";

        document.getElementsByClassName("xAxis")[3]
            .innerHTML="Partially Damaged";

	 var death=convert((document.getElementsByClassName("yAxis")[0]
            .innerHTML).replace(/\,/g,''));
			
		//console.log("death converted",death);
		   
		var injured=convert((document.getElementsByClassName("yAxis")[1]
            .innerHTML).replace(/\,/g,''));
		var fully=convert((document.getElementsByClassName("yAxis")[2]
            .innerHTML).replace(/\,/g,''));
		var partial=convert((document.getElementsByClassName("yAxis")[3]
            .innerHTML).replace(/\,/g,''));
			
			
        document.getElementsByClassName("yAxis")[0]
            .innerHTML=(parseInt(death)).toLocaleString();

        document.getElementsByClassName("yAxis")[1]
            .innerHTML=(parseInt(injured)).toLocaleString();

        document.getElementsByClassName("yAxis")[2]
            .innerHTML=(parseInt(fully)).toLocaleString();

        document.getElementsByClassName("yAxis")[3]
            .innerHTML=(parseInt(partial)).toLocaleString();
    ...
    /*    console.log("नेपाल");
        ...
        document.getElementById("content").appendChild(about);*/
			...
			function convert(str){
				...
				str=str.replace(/[०-९]/g,function(str){
				//	console.log("terms",str);
				if(str=='०') return '0';
				else if(str=='१') return '1';
				else if(str=='२') return '2';
				else if(str=='३') return '3';
				else if(str=='४') return '4';
				else if(str=='५') return '5';
				else if(str=='६') return '6';
				else if(str=='७') return '7';
				else if(str=='८') return '8';
				if(str=='९') return '9';	
						
				});
				//console.log("terms to be replaced",str);
